...
import com.bobomee.android.mentions.R;
...
public class EllipsizeTextView extends TextView {
  ...
  private CharSequence mEllipsizeText = DEFAULT_ELLIPSIZE_TEXT;
  private int mEllipsizeIndex = 0;
  ...
  private void onInitialize(Context context,AttributeSet attrs) {
    if (null != attrs) {
